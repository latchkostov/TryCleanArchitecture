...
using TryCleanArchitecture.Core.ProjectAggregate;
using TryCleanArchitecture.Core.Services;
using TryCleanArchitecture.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace TryCleanArchitecture.UnitTests.Core.Services
{
